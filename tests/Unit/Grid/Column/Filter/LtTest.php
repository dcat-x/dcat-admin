...
use Dcat\Admin\Grid\Column\Filter\Lt;
use Dcat\Admin\Grid\Model;
use Dcat\Admin\Tests\TestCase;
use Mockery;

class TestableLt extends Lt
{
...
class LtTest extends TestCase
{
    ...
    public function test_add_binding_uses_less_than_operator(): void
    {
        $filter = new TestableLt;
    ...
    public function test_make_factory_method(): void
    {
        ...
        $this->assertInstanceOf(Lt::class, $filter);
    }
}
