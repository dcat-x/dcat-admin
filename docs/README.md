...
> 本项目是 Dcat Admin X,仓库地址: https://github.com/dcat-x/dcat-admin
...
- [视图与自定义页面](getting-started/custom-page.md)
- [JS 组件](getting-started/js.md)
- [多应用 (多后台)](getting-started/multi-app.md)
- [Laravel Octane](getting-started/laravel-octane.md)
- [常见问题](getting-started/qa.md)

## 数据表格

- [基本使用](grid/basic.md)
- [列的使用和扩展](grid/column.md)
- [列的显示和扩展](grid/column-display.md)
- [新增列显示](grid/new-displayers.md)
- [行的使用和扩展](grid/actions.md)
- [工具栏](grid/custom-tools.md)
- [树状表格](grid/tree.md)
- [组合表头](grid/combination.md)
- [数据源](grid/data.md)
- [关联关系](grid/relationship.md)
- [查询过滤](grid/filters.md)
- [列过滤器](grid/column-filter.md)
- [快捷搜索](grid/quick-search.md)
...
- [事件](grid/events.md)
- [字段翻译](grid/trans.md)
- [头部和脚部](grid/header.md)
- [软删除](grid/softdelete.md)
- [异步渲染](grid/async.md)

## 数据表单

- [基本使用](form/basic.md)
- [图片/文件上传](form/upload.md)
- [字段使用](form/fields.md)
- [新增表单字段](form/new-fields.md)
- [字段扩展](form/field-management.md)
- [数据源](form/data.md)
- [表单弹窗](form/modal.md)
- [关联关系](form/relationship.md)
- [JSON 表单](form/json.md)
- [字段动态显示](form/when.md)
- [表单分步](form/step.md)
...
- [基本使用](show/basic.md)
- [字段显示](show/field.md)
- [新增详情字段](show/new-fields.md)
- [关联关系](show/relation.md)
- [显示扩展](show/extend.md)
- [初始化](show/init.md)
- [字段翻译](show/trans.md)
...
- [基本使用](model-tree/basic.md)
- [数据仓库](model-tree/repository.md)

## 动作

- [基本使用](action/basic.md)
- [数据表格](action/grid.md)
- [数据表单](action/form.md)
- [数据详情](action/show.md)
- [模型树](action/tree.md)
...
- [扩展基本使用](extension/basic.md)
- [开发扩展](extension/dev.md)
- [开发主题](extension/theme.md)
- [开发工具](extension/helpers.md)
- [扩展升级](extension/upgrade.md)

## 页面组件

- [异步加载](widgets/lazy.md)
