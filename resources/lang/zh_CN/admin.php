...
return [
    ...
    'client' => [
        ...
        'auto_save_tip' => '检测到未保存的草稿，是否恢复？',
        'auto_save_restore' => '恢复',
        'auto_save_discard' => '丢弃',
        'auto_save_restored' => '草稿已恢复',
    ],
    'home' => '主页',
    'online' => '在线',
    'login' => '登录',
    ...
    'oss_upload' => [
        'drag_or_click' => '拖拽文件到此处或点击选择',
        'max_size' => '支持最大 :sizeMB 的文件上传',
        'allowed_formats' => '，支持格式：:formats',
        'success' => '上传成功',
        'failed' => '上传失败，请重试',
        'deleted' => '文件已删除',
        'link_copied' => '下载链接已复制到剪贴板',
        'copy_failed' => '复制失败，请手动复制：',
        'confirm_delete' => '确定要删除这个文件吗？',
        'no_file_path' => '没有可复制的文件路径',
        'file_too_large' => '文件大小不能超过 :sizeMB',
        'unsupported_type' => '不支持的文件类型，仅支持：:types',
        'sts_error' => '获取上传凭证失败，请刷新页面重试',
        'copy_link' => '复制下载链接',
        'delete' => '删除文件',
        'reupload' => '重新上传',
    ],
    'data_rule' => [
        ...
        'menu' => '所属菜单',
        'field' => '字段名',
        'field_help' => '数据库表字段名，如 department_id, created_by',
        'condition' => '条件',
        'value' => '规则值',
        'value_help' => '使用变量类型时，可使用系统变量如 {user_id}',
        'value_type' => '值类型',
        'value_type_fixed' => '固定值',
        'value_type_variable' => '变量',
        'scope' => '作用域',
        'scope_row' => '行级权限',
        'scope_column' => '列级权限',
        'scope_form' => '表单字段',
        ...
        'var_user_id' => '当前用户ID',
        'var_username' => '当前用户名',
        'var_department_id' => '主部门ID',
        'var_department_ids' => '所有部门ID',
        'var_department_path' => '主部门路径',
    ],
    'data_rules' => '数据规则',
    'batch_input' => [
        'batch' => '批量',
        'title' => '批量查询',
        'description' => '输入内容，支持换行、逗号、分号分隔，可直接粘贴',
        'placeholder' => '输入关键词回车搜索...',
        'item' => '条记录',
        'no_match' => '未找到匹配的记录',
        'matched' => '匹配 :matched/:total 条记录',
        'please_input' => '请输入内容',
        'network_error' => '网络请求失败，请重试',
        'exceed_max' => '最多支持 :max 条',
        'no_valid' => '没有有效的内容',
        'identified' => '共识别到 <strong>:count</strong> 个',
