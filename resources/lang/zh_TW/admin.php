...
return [
    ...
    'client' => [
        ...
        'auto_save_tip' => '偵測到未儲存的草稿，是否恢復？',
        'auto_save_restore' => '恢復',
        'auto_save_discard' => '丟棄',
        'auto_save_restored' => '草稿已恢復',
    ],
    'home' => '首頁',
    'online' => '在線',
    'login' => '登入',
    ...
    'batch_input' => [
        'batch' => '批次',
        'title' => '批次查詢',
        'description' => '輸入內容，支援換行、逗號、分號分隔，可直接貼上',
        'placeholder' => '輸入關鍵詞按 Enter 搜尋...',
        'item' => '筆記錄',
        'no_match' => '未找到匹配的記錄',
        'matched' => '匹配 :matched/:total 筆記錄',
        'please_input' => '請輸入內容',
        'network_error' => '網路請求失敗，請重試',
        'exceed_max' => '最多支援 :max 筆',
        'no_valid' => '沒有有效的內容',
        'identified' => '共識別到 <strong>:count</strong> 個',
